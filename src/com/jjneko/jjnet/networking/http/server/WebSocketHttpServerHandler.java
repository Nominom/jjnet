...
import com.jjneko.jjnet.networking.pipes.http.SimpleHttpServerPipe;
...
public class WebSocketHttpServerHandler extends SimpleChannelInboundHandler<Object>{
    ...
    public static Logger logger = Logger.getLogger(WebSocketHttpServerHandler.class.getName());
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) {
        ...
        if ("/".equals(req.uri())) {
            ByteBuf content = WebSocketHttpServerTestPage.getContent(getWebSocketLocation(req));
	...
	public static void setSSL(boolean SSL) {
		WebSocketHttpServerHandler.SSL = SSL;
	}
}